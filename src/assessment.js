...
// #9  ###################
// # Prototype 2
// Write a constructor function called chimichanga.  It has a property called
//percentLeft = 100.  It has a prototype function called eat.  When eat is
//invoked it uses context to implicitly subract 20 from the precentLeft on the chimichanga.
...
// When addIngredient is invoked it saves that ingredient with previously added
//ingredients and then returns an object that looks like this (Replace the parts wrapped in <> with correct data):
// ```
// {
...
function subway(personName) {
  ...
  return function addIngredient(ingredients) {
    ...
    return {orderPerson: personName, ingredients: ingredientList}
  }
}
